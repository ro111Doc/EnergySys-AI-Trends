...
* **【Evidence 计量证据】** 网络（图 3）涌现出数篇拥有高局部中介中心性（Betweenness Centrality $> 0.1$）和高被引频次的里程碑文献：
  1. **早期知识库**：以“住宅/居民级负荷预测”为核心。奠定了将气象特征（温度、湿度）作为外生变量输入 LSTM 网络的标准工程范式。由于早期资料较少，通过筛选后此处是选出了最有代表性的一篇。
...
| 进度 / 成员 | 👨‍💻 刘泽熙(ro111DOC) | 👩‍💻 龚乐瑶(Lokyo-git) | 👨‍💻 郭逸清(WanNanzhuo) | 👨‍💻 兰宏智(Zehiel666) |
| :--- | :--- | :--- | :--- | :--- |
